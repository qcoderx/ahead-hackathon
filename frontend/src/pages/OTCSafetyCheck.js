  ...
  return (
    <PatientLayout>
      <div className="flex flex-col flex-1 items-center justify-center py-12 sm:py-24">
        {/* PageHeading */}
        <div className="flex flex-wrap justify-center text-center gap-3 p-4 w-full max-w-2xl">
        ...
        <div className="w-full max-w-2xl mt-8 space-y-6">
            ...
            <div className="p-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 rounded-lg bg-white dark:bg-black/20 p-6 shadow-md border border-caution/30">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm font-normal leading-normal text-gray-600 dark:text-gray-400">
                    This medication should be used with caution. Please consult
                    a healthcare provider before use to discuss potential risks
                    and benefits.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 rounded-lg bg-white dark:bg-black/20 p-6 shadow-md border border-danger/30">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm font-normal leading-normal text-gray-600 dark:text-gray-400">
                    ...
                    Please seek professional medical advice for safer
                    alternatives.
                  </p>
                  <Link
          ...
          {/* No Results State */}
          {result === "not-found" && (
            <div className="flex flex-col items-center justify-center text-center p-10 bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark">
