...
// [CHANGE 1] Update interface to accept the result object
interface SingleDrugCheckScreenProps {
  patient?: Patient;
  onBack: () => void;
  onAnalyze: (drugName: string, symptoms?: string, result?: any) => void;
  onViewHistory: () => void;
}
...
const SingleDrugCheckScreen: React.FC<SingleDrugCheckScreenProps> = ({
  patient = {
    ...
    name: "Jessica Alba",
    avatar:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBlxqKL03tQJ2_Mg35vpzD3O0oMwrbsnjw8-ZbDk0PrVuOUSWy-1x5x3Hx7u2iMWRnpnTrIq6rKPX2CHxh6ksMTuNA9DwV6yeYmLqsDm-N6oZ8la2D6oQb6WU3Yni1FGxMshJdO0aSaEx8Q0B7jNgK9DdUbLtaQYIz4hitwjuBVAdtjiRgwXw5XxGRjgP7GfbKHUyURvkd2j2vQiRFeVlg401TjlP26icgpQrEf9l7hCSdx9pOpR3krL5tY99yDAJtouGpKBYH54haS",
    age: 32,
    gestationalWeek: 28,
    lastVisit: "03/15/24",
    riskScore: 7.8,
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // [CHANGE 2] Capture the response from the hook
      ...
      // [CHANGE 3] Pass the response to the parent component
              ...
              <div className="col-span-3 text-center pt-2">
                ...
                <p
                  className={`font-bold text-lg ${
                    getRiskColor(patient.riskLevel).split(" ")[0]
                  }`}
                >
